...
function initBuffers(gl) {
    ...
    const textureCoordinates = [
        ...
        66.85/256, 8.4/1024,
        48.25/256, 8.4/1024,
        88.15/256, 136.85/1024,
        106.85/256, 136.85/1024,
        106.85/256, 128.15/1024,
...
function draw(gl, programInfo, buffers, texture, rotator) {
    ...
    glMatrix.mat4.translate(modelViewMatrix, modelViewMatrix, [-140, -60, -56]);
    ...
    gl.drawElements(gl.TRIANGLES, 411, gl.UNSIGNED_SHORT, 0);
}
